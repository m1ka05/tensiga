...
for k in range(domain.dim):
    domain.href(np.linspace(0, 0.5, 8)[1:-1], k)
    domain.href(np.linspace(0.5, 1, 8)[1:-1], k)

    idomain.href(np.linspace(0, 0.5, 8)[1:-1], k)
    idomain.href(np.linspace(0.5, 1, 8)[1:-1], k)
